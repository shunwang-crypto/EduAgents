...
2. **学习计划（Adaptive Learning Plan & Explanation）**
   ...
   - **Learning Map（学习地图）**：动态知识图谱 + 学习者状态叠加，核心导航；支持「当前学习路径 / 完整知识图」两种模式；仅一个「当前推荐」知识点
   - **Structured Explanation（结构化讲解 / 学习讲解）**：每个知识点按结构化分块讲解（为什么学 / 整体模型 / 核心概念 / 示例拆解 / 常见误区 / 项目应用 / 总结 / 进入实践），非长文、非聊天
